...
/**
 * @class TOPTWSolution
 * @brief Represents a solution to a TOPTW instance.
 *
 * This class encapsulates the solution structure for the Team Orienteering Problem with Time Windows (TOPTW),
 * including route assignments, predecessor and successor relationships, waiting times, and objective function value.
 * It provides methods for initializing, evaluating, and manipulating solutions, supporting fitness calculation,
 * route management, and solution comparison.
 */
