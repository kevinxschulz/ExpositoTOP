 ...
 *
 * This class models the structure and data of a TOPTW problem, including the number of routes,
 * points of interest (POIs), their coordinates, service times, scores, and time windows.
 * It provides methods to set and retrieve these attributes, as well as to calculate the distance matrix
 * required for route optimization algorithms.
 *
 * The class serves as the main data container for problem instances and supports initialization
 * and manipulation of all relevant parameters for solving the TOPTW.
 */
